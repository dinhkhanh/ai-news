...
**Phase 4: editor.** Timeline JSON versioning, editor UI, comments, approval flow.

**Phase 5: publishing.** YouTube first; Meta and TikTok as reviews clear. Scheduling, idempotent publish, status polling, disclosure flags, analytics pull + dashboard.
